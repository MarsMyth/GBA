...
public class MechanicalFermenterBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    private final int DEFAULT_MAX_PROGRESS = 5000;

    public MechanicalFermenterBlockEntity(BlockPos pos, BlockState state) {
        super(AlcoholBlockEntities.MECHANICAL_FERMENTER_BE, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> MechanicalFermenterBlockEntity.this.progress;
                    case 1 -> MechanicalFermenterBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: MechanicalFermenterBlockEntity.this.progress = value;
                    case 1: MechanicalFermenterBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new MechanicalFermenterScreenHandler(syncId, playerInventory, this, propertyDelegate);
    }
