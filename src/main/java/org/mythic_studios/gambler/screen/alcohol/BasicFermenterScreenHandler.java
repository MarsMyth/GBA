...
public class BasicFermenterScreenHandler extends ScreenHandler {
    ...
    public final BasicFermenterBlockEntity blockEntity;

    public BasicFermenterScreenHandler(int syncId, PlayerInventory inventory, BlockPos pos) {
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(pos), new ArrayPropertyDelegate(2));
    }

    public BasicFermenterScreenHandler(int syncId, PlayerInventory playerInventory,
                                BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(AlchoholScreenHandlers.BASIC_FERMENTER_SCREEN_HANDLER, syncId);
