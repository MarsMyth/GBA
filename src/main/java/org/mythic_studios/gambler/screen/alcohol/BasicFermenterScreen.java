...
public class BasicFermenterScreen extends HandledScreen<BasicFermenterScreenHandler> {
    ...
    public BasicFermenterScreen(BasicFermenterScreenHandler handler, PlayerInventory inventory, Text title) {
